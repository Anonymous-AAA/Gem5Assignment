...
policies=[RandomRP,LRURP,FIFORP,MRURP]
...
repl_policy=policies[int(repl)]
assoc=assocs[int(assoc)]

print(f"Starting the simulation for associativity {assoc} and replacement policy {repl_policy().type}")
